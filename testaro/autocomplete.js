...
const reporter = async (page, report, _0, withItems, labels = {
    ...
    const getBadWhat = (element) => {
        ...
        else if (accessibleName && type === 'text' && labels.name.some(label => accessibleName.includes(label))) {
            requiredAuto = 'name';
        }
    ...
    return (0, testaro_1.doTest)(page, report, withItems, 'autocomplete', selector, whats, 2, getBadWhatString);
};
