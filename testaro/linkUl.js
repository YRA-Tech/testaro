...
const reporter = async (page, report, _, withItems) => {
    ...
    const getBadWhat = (element) => {
        ...
        if (!textDecorationLine.includes('underline')) {
            ...
            if (compact(element.textContent) !== compact(ancestor?.textContent)
    ...
    return await (0, testaro_1.doTest)(page, report, withItems, 'linkUl', 'body a', whats, 1, getBadWhat.toString());
};
