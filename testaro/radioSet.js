...
/*
  ...
  Compiled to radioSet.js by tsc (issue #73); edit this file, not the emitted one.
*/
// FUNCTIONS
...
const reporter = async (page, report, _, withItems) => {
    ...
    return await (0, testaro_1.doTest)(page, report, withItems, 'radioSet', 'body input[type=radio]', whats, 2, getBadWhat.toString());
};
