...
/*
  ...
  Compiled to datalistRef.js by tsc (issue #73); edit this file, not the emitted one.
*/
// FUNCTIONS
const reporter = async (page, report, _, withItems) => {
    ...
    return await (0, testaro_1.doTest)(page, report, withItems, 'datalistRef', 'body input[list]', whats, 3, getBadWhat.toString());
};
